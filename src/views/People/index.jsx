    ...
    <Row gutter={[0, 8]}>
      <Section xs={{ span: 22, offset: 1 }} sm={{ span: 12, offset: 6 }} md={{ span: 12, offset: 6 }}>
        ...
        <blockquote style={{ fontStyle: 'italic' }}>
          ...
          oriented, and willing to both teach/mentor others as well as learn from others. James would always be involved
          in my interviewing for new members of my team as he could always ask the right question or give a good problem
          to solve to the interviewee. Would hire James again in the future if the opportunity came up.
        </blockquote>
